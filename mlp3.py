...
# N = 60
# O = 30
# Combination for L,M,N is
# 200,100,60 ; 200,60,30 ; 200,100,30 ; 100,60,30
L = 200
M = 100
N = 60
...
w4 = tf.get_variable("w4", shape=(N,10), initializer=tf.random_normal_initializer(0,0.01))
b4 = tf.get_variable("b4", shape=(1,10), initializer=tf.zeros_initializer())
